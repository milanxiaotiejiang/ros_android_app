...
//        CameraVideoController videoController = new CameraVideoController(null);
        NormalAudioController audioController = new NormalAudioController();
        mStreamController = new StreamController(null, audioController);
//        mRenderer.setCameraOpenListener(mCameraOpenListener);
    ...
    public void init() {
        ...
        PowerManager mPowerManager = ((PowerManager) mContext.getSystemService(mContext.POWER_SERVICE));
