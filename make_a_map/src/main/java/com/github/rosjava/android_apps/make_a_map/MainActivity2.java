...
import com.github.rosjava.android_apps.make_a_map.R;
...
public class MainActivity2 extends Activity {
        ...
        mRecordBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (isRecording) {
                    ...
                    Toast.makeText(MainActivity2.this, "stop living", Toast.LENGTH_SHORT).show();
        ...
        okBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(uploadUrl)) {
                    Toast.makeText(MainActivity2.this, "Upload address is empty!", Toast.LENGTH_SHORT).show();
                } else {
                    mRtmpSender.setAddress(uploadUrl);
                    mProgressConnecting.setVisibility(View.VISIBLE);
                    Toast.makeText(MainActivity2.this, "start connecting", Toast.LENGTH_SHORT).show();
    ...
    private void initLiveView() {
        ...
        mLFLiveView.setCameraOpenListener(new CameraListener() {
            ...
            public void onOpenSuccess() {
                Toast.makeText(MainActivity2.this, "camera open success", Toast.LENGTH_LONG).show();
            }

            @Override
            public void onOpenFail(int error) {
                Toast.makeText(MainActivity2.this, "camera open fail", Toast.LENGTH_LONG).show();
            }

            @Override
            public void onCameraChange() {
                Toast.makeText(MainActivity2.this, "camera switch", Toast.LENGTH_LONG).show();
            }
        });
        ...
        mLFLiveView.setLivingStartListener(new CameraLivingView.LivingStartListener() {
            ...
            public void startError(int error) {
                //直播失败
                Toast.makeText(MainActivity2.this, "start living fail", Toast.LENGTH_SHORT).show();
                mLFLiveView.stop();
            }
            ...
            public void startSuccess() {
                //直播成功
                Toast.makeText(MainActivity2.this, "start living", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private RtmpSender.OnSenderListener mSenderListener = new RtmpSender.OnSenderListener() {
        ...
        public void onDisConnected() {
            mProgressConnecting.setVisibility(View.GONE);
            Toast.makeText(MainActivity2.this, "fail to live", Toast.LENGTH_SHORT).show();
            mRecordBtn.setBackgroundResource(R.mipmap.ic_record_start);
            mLFLiveView.stop();
            isRecording = false;
        }
        ...
        public void onPublishFail() {
            mProgressConnecting.setVisibility(View.GONE);
            Toast.makeText(MainActivity2.this, "fail to publish stream", Toast.LENGTH_SHORT).show();
            mRecordBtn.setBackgroundResource(R.mipmap.ic_record_start);
            isRecording = false;
        }
    ...
    public class GestureListener extends GestureDetector.SimpleOnGestureListener {
        ...
        public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
            if (e1.getX() - e2.getX() > 100
                ...
                // Fling left
                Toast.makeText(MainActivity2.this, "Fling Left", Toast.LENGTH_SHORT).show();
            } else if (e2.getX() - e1.getX() > 100
                    && Math.abs(velocityX) > 200) {
                // Fling right
                Toast.makeText(MainActivity2.this, "Fling Right", Toast.LENGTH_SHORT).show();
            }
