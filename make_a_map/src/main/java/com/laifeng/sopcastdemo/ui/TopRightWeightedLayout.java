...
public class TopRightWeightedLayout extends LinearLayout {
    ...
    public void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        for (int i = 0; i < getChildCount(); i++) {
            ...
            if (button instanceof com.laifeng.sopcastdemo.ui.MultiToggleImageButton) {
                com.laifeng.sopcastdemo.ui.MultiToggleImageButton toggleButton = (com.laifeng.sopcastdemo.ui.MultiToggleImageButton) button;
                toggleButton.setParentSize(size);
                toggleButton.setAnimDirection(mIsPortrait ?
                        com.laifeng.sopcastdemo.ui.MultiToggleImageButton.ANIM_DIRECTION_VERTICAL :
                        com.laifeng.sopcastdemo.ui.MultiToggleImageButton.ANIM_DIRECTION_HORIZONTAL);
            }
        }
    }
